...
(cl:in-package server_clien-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server_clien-srv:<AddInts-request> is deprecated: use server_clien-srv:AddInts-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server_clien-srv:num1-val is deprecated.  Use server_clien-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server_clien-srv:num2-val is deprecated.  Use server_clien-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server_clien-srv:<AddInts-response> is deprecated: use server_clien-srv:AddInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server_clien-srv:sum-val is deprecated.  Use server_clien-srv:sum instead.")
  (sum m))
